...
namespace AttacheCase
{
  class FileDecrypt3
  {
    ...
    // Data File Version ( DATA_FILE_VERSION = 130 )
    ...
    public bool Decrypt(
      ...
      string FilePath, string OutDirPath, string Password, byte[] PasswordBinary, Action<int, string, IReadOnlyList<string>> dialog)
    {
